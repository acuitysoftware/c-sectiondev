<x-admin.form-section submit="saveOrUpdate">
    <x-slot name="form">
      ...
      <x-admin.form-group>
	        ...
	        <x-admin.dropdown  wire:model.defer="board_id" placeHolderText="Please select Board" autocomplete="off" >
	    ...
	    <x-admin.form-group >
	        ...
	        <x-admin.input type="text" wire:model.defer="name" placeholder="Class Name"  />
	        <x-admin.input-error for="name" />
	    </x-admin.form-group>

        <x-admin.form-group >
	        <x-admin.lable value="Tution Fee" required />
	        <x-admin.input type="number" wire:model.defer="price" placeholder="Tution Fee"  />
