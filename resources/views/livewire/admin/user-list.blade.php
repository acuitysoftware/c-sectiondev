<x-admin.table>
    ...
    <x-slot name="thead">
        ...
        <tr role="row">
            ...
            <th tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 16%;"
                aria-label="Company Agent: activate to sort column ascending">Board</th>
            <th tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 16%;"
                aria-label="Company Agent: activate to sort column ascending">Class</th>
            <th class="align-center" tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 16%;"
