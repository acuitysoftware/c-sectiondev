<!DOCTYPE html>
        <html lang="en">
          <head>
            ...
            <title>Wild Spice Gift Voucher Email</title>
          ...
          <tr style="vertical-align: top">
              ...
              <div style="margin: 0 auto;width: 100%; display: flex;">
                ...
                <div class="colL" style=" float: left; width: 50%;  align-items: center; justify-content: space-between; background-image: url({{asset('public/assets/images/Lbg.png')}});background-size: contain;">
                    ...
                    <tbody>
                      <tr>
                        <td class="v-text-align" style="padding: 25px;" align="center">
                          ...
                          <img align="center" border="0" src="{{asset('public/assets/images/mail_logo.png')}}"  alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important; border: none; height: auto; float: none;width: 100%;">
                          </a>
                        </td>
                      </tr>
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0" style="margin-top: 70px;">
                    <tbody>
                      <tr>
                        <td class="v-text-align" style="font-size: 16px;  padding: 0 25px; color: #fff; font-weight: 600; line-height: 25px;" align="center">
                          {{$setting->address}}
                        </td>
                      </tr>
                      <tr>
                        <td class="v-text-align" style="font-size: 16px;  padding: 0 25px; color: #fff; font-weight: 600; line-height: 25px;" align="center">
                          {{$setting->phone}} / {{$setting->phone_2}}
                        </td>
                      </tr>
                      <tr>
                        <td class="v-text-align" style="font-size: 16px;  padding: 0 25px; color: #fff; font-weight: 600; line-height: 25px;" align="center"> <a href="{{asset('')}}" target="_blank">{{asset('')}}</a></td>
                      </tr>
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0" style="margin-top: 70px;">
                    <tbody>
                      <tr>
                        <td class="v-text-align" style="font-size: 14px;  padding: 0 25px 0 15px; color: #000; font-weight: 600;" align="center">
                          <p style="text-align: center;">Redeemable once. Not redeemable for cash. No Change given. Valid only at Wild Spice Indian Restaurant</p>
                        </td>
                      </tr>
           ...
           @endif
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                    <tbody>
                      <tr>
                        <td class="v-text-align" style="font-size: 14px;  padding: 25px 25px; color: #fff; font-weight: 600;" align="center">
                          <p style="text-align: center;">T&C Valid for 12 months. Redeemable onces. Not redeemable for cash. No change given. Valid only at Wild Spice Indian Restaurant. Present / mention the Voucher code when use.</p>
                        </td>
                      </tr>
